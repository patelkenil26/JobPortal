    ...
    <section className="jobs1 page py-16 bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {jobs.jobs &&
            jobs.jobs.slice(0, 3).map((job) => (
              <div
                className="card p-6 bg-gray-50 rounded-lg shadow-lg border border-gray-100"
                key={job._id}
              >
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <Badge className="bg-green-100 text-green-600">
                    Salary: {job.salaryFrom}-{job.salaryTo} LPA
                  </Badge>
                </div>
        ...
        <div className="text-center mt-8">
          <Link to={"job/getall"} className="text-blue-600 font-semibold">
            View All Jobs
          </Link>
        </div>
      </div>
