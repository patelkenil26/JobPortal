  ...
  return (
    <section className="jobDetail page bg-gray-50 py-10">
      <div className="container max-w-5xl mx-auto bg-white p-10 rounded-lg shadow-lg">
        <h1 className="text-4xl font-bold border-b pb-5 mb-8 text-gray-700">Job Description</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-xl font-semibold text-gray-900">Requirement:</h1>
          ...
          <div className="flex items-center space-x-4">
            <h1 className="text-xl font-semibold text-gray-900">No of Positions:</h1>
          ...
          <div className="space-y-2">
            <h1 className="text-xl font-semibold text-gray-900">Experience required:</h1>
            <span className="text-lg text-gray-600">{job?.experienceLevel} yrs</span>
          </div>
          ...
          <div className="space-y-2">
            <h1 className="text-xl font-semibold text-gray-900">Posted Date:</h1>
          ...
          {user && user.role === "Employer" ? (
            ...
            <div className="mt-8">
              <Link to={`/application/${job._id}`} className="bg-blue-600 text-white font-semibold py-3 px-8 rounded-md shadow hover:bg-blue-700">
                Apply Now
              </Link>
            </div>
          )}
